    ...
    <div className="pf-page relative flex min-h-screen flex-col">
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-12 sm:px-6">
        <div className="animate-fade-up w-full max-w-md text-center">
          ...
          <div className="terminal-scanlines mt-8 rounded-2xl border border-emerald-500/25 bg-zinc-950/60 px-6 py-10 sm:px-10 sm:py-12">
            <div className="animate-pulse-glow mx-auto inline-flex size-14 items-center justify-center rounded-xl border border-emerald-500/40 bg-emerald-500/15">
              <Zap className="size-6 text-emerald-400" aria-hidden />
            </div>
            ...
            <p className="mt-2 font-mono text-xs tracking-[0.2em] text-emerald-600 uppercase dark:text-emerald-400/90">
              // ESTABLISHING CONNECTION
            </p>

            <div className="mx-auto mt-8 h-1 max-w-xs overflow-hidden rounded-full bg-zinc-900/70 ring-1 ring-emerald-500/10">
              <div className="animate-shimmer h-full w-full rounded-full bg-gradient-to-r from-transparent via-emerald-400 to-transparent" />
            </div>
            ...
            <ul className="mx-auto mt-8 max-w-xs space-y-1.5 text-left font-mono text-[11px] text-zinc-400">
              ...
              >
                ...
                <span className="inline-flex items-center gap-0.5">
                  <span
                    className="h-1 w-1 animate-pulse rounded-full bg-emerald-400/80"
                    style={{ animationDelay: '0ms' }}
                  />
                  <span
                    className="h-1 w-1 animate-pulse rounded-full bg-emerald-400/80"
