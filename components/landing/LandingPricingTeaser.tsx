      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <RevealOnScroll delay={80}>
          <div className="pf-feature-card relative flex h-full flex-col overflow-hidden rounded-2xl border-neon-500/30 p-6 ring-1 ring-neon-500/20 sm:rounded-3xl sm:p-8">
            ...
            <Link
              href="/pricing"
              className="motion-btn-press mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-neon-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-neon-500 dark:bg-neon-500 dark:text-zinc-950 dark:hover:bg-neon-400"
            >
              See full pricing
              <ArrowRight className="size-4" />
            </Link>
