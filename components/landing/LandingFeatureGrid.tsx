...
export function LandingFeatureGrid() {
  return (
    <section id="features" className="mb-20 sm:mb-32 lg:mb-40">
      <RevealOnScroll className="mb-10 text-center sm:mb-16">
        <h2 className="pf-heading mb-4 font-heading text-3xl font-bold tracking-tight sm:text-4xl">
          ...
          <span className="text-neon-600 dark:text-neon-500">instantly.</span>
        </h2>
      ...
      <div className="grid auto-rows-[minmax(180px,auto)] grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
        <RevealOnScroll className="md:col-span-2" delay={0}>
          <div className={cardClass}>
            <div className="absolute -top-4 -right-4 text-neon-500 opacity-[0.07] transition-all duration-500 group-hover:scale-110 group-hover:opacity-[0.12] sm:top-0 sm:right-0 sm:p-8 dark:opacity-20 dark:group-hover:opacity-100">
              <Code2 className="size-24 sm:size-32" />
            </div>
            <div className="relative z-10 flex h-full max-w-md flex-col justify-end">
              <div className={`${iconBoxClass} text-neon-600 dark:text-neon-400`}>
        ...
        <RevealOnScroll delay={80}>
          <div className={cardClass}>
            <div className="absolute -bottom-8 -right-8 text-neon-500 opacity-[0.07] transition-all duration-500 group-hover:rotate-12 group-hover:opacity-[0.12] sm:opacity-[0.08] dark:sm:opacity-20 dark:sm:group-hover:opacity-30">
        ...
        <RevealOnScroll delay={160}>
          <div className={cardClass}>
            <div className="absolute -top-2 -right-2 text-neon-500 opacity-[0.07] transition-all duration-500 group-hover:translate-x-2 group-hover:opacity-[0.12] sm:top-0 sm:right-0 sm:p-8 dark:opacity-20 dark:sm:group-hover:opacity-100">
        ...
        <RevealOnScroll className="md:col-span-2" delay={240}>
          <div className={cardClass}>
            <div className="absolute top-1/2 right-6 hidden h-48 w-48 -translate-y-1/2 items-center justify-center rounded-full border border-neon-500/20 transition-transform duration-700 group-hover:scale-105 sm:flex">
              <div className="flex h-32 w-32 items-center justify-center rounded-full border border-neon-500/30">
                <div className="h-16 w-16 rounded-full bg-neon-500/20 blur-xl" />
              </div>
            </div>
